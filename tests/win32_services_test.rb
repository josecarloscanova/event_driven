...
module Nanotek 
    ...
    #  WmiServiceConfigurator
      def test_system_32
        ...
        wmi_service = Nanotek::WmiService.new({:service => class_loaded["Win32_Service"].name , location => class_loaded["Win32_Service"].path})
        win32_system_instances =  wmi_service.instances_of(class_loaded["Win32_Service"].name)
        result =  wmi_service.get_instances_of({:class => class_loaded["Win32_Service"].name , :wcf => wcf ,  :result => win32_system_instances})
    ...
    class YamlUnMarshaller
        ...
        attr_reader(:class_loaded)
          ...
          def unmarshall
            ...
            @@class_loaded = YAML.load(IO.read("C:/cygwin64/home/user/event_driven/wmi/classes/yaml/Win32_Service.yml"))
          end  
