...
module Nanotek 
    ...
    #  WmiServiceConfigurator
      def test_system_32
        ...
        wmi_service = Nanotek::WmiService.new({:service => class_loaded["Win32_SystemSlot"].name , location => class_loaded["Win32_SystemSlot"].path})
        wmi_service.get_instances_of({:class => class_loaded["Win32_SystemSlot"].name , :wcf => wcf})
      end
    ...
    class YamlUnMarshaller
          ...
          def YamlUnMarshaller.unmarshall
              $class_loaded = YAML.load(IO.read("C:/cygwin64/home/user/event_driven/wmi/classes/yaml/Win32_SystemSlot.yml"))
          end  
